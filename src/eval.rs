...
impl Evaluator {
    ...
    fn builtin_fanout(&mut self) -> Result<(), EvalError> {
    ...
    fn builtin_zip(&mut self) -> Result<(), EvalError> {
    ...
    fn builtin_cross(&mut self) -> Result<(), EvalError> {
        let list2 = self.stack.pop().ok_or_else(||
    ...
    fn builtin_retry(&mut self) -> Result<(), EvalError> {
        let block = self.stack.pop().ok_or_else(||
